...
void THDM::write_LesHouches(const char* file, bool fulldecay, bool couplings, bool qcd_on, bool HBHS) {
  complex <double> I(0.0,1.0);
...
fprintf(output,"Block MINPAR    # Model parameters\n");
  ...
  fprintf(output, "%5d   %5d   %6d %16.8E %5d    # h\n",  1, hbres[1],hbchan[1],hbobs[1],hbcomb[1]);
